...
//////////////////////////////////////////////////////////////////////////
#if defined(POR_INITCOMPILE) //초기업데이트만 가능한 판본에서는 DONGLE만 유효
	#undef POR_WITH_CAMERA
	#undef POR_WITH_IOMODULE
	#undef POR_WITH_MYSQL
	#undef POR_WITH_SQLITE

#elif defined(POR_EMULATOR)	//모의기판본에서는 카메라, 리력, DONGLE, IO모듈이 무효
	#undef POR_WITH_CAMERA
	#undef POR_WITH_IOMODULE
	#undef POR_WITH_DONGLE

#elif !defined(POR_PRODUCT)	//제품판본이 아닌경우 DONGLE이 무효
	#undef POR_WITH_DONGLE
#endif
...
//#define POR_SUPPORT_CONNECTCOMPONENTS
...
#define PO_HIGHLEVEL_NAME				"mold_vision.exe"
	...
	#define PO_LOG_FILENAME				"c:\\log\\imvs2_log.txt"
	#define PO_TIMELOG_FILENAME			"c:\\log\\imvs2_timelog.txt"
	#define PO_DATABASE_PATH			"c:\\database\\imvs2"
	#define PO_DEBUG_PATH				"c:\\log\\"
#else
    #define PO_LOG_PATH					"/opt/imvs2/log"
    #define PO_LOG_FILENAME				"/opt/imvs2/log/mv_log.txt"
    #define PO_TIMELOG_FILENAME			"/opt/imvs2/log/mv_timelog.txt"
    #define PO_DATABASE_PATH			"/opt/imvs2/database"
	#define PO_DEBUG_PATH				"/home/nfs/tmp/"
#endif
...
#define	PO_MVIO_MAXINADDR				32
#define	PO_MVIO_MAXOUTADDR				32
...
#if defined(POR_IA64)
#pragma comment(lib, "cumvs64.lib")
#else
#pragma comment(lib, "cumvs86.lib")
#endif
#endif
